...
namespace NAN2026
{
    // 미노타우르스 보스: idle→walk→atk_1/atk_2(타격창+통일 패링)→take_hit→death. 체력바 동봉 UI.
    public class MinoBossAI : MonoBehaviour
    {
        ...
        private int hp;
        private int state; // 0 idle 1 walk 2 attack 3 hit 4 death
        ...
        private void BuildBar()
        {
            ...
            root.transform.localPosition = new Vector3(0f, config.barOffsetY, 0f);
        ...
        public void TakeDamage(int dmg)
        {
            ...
            if (state != 2) SetState(3); // 공격 중엔 슈퍼아머
        }
